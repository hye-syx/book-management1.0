...
export const books = pgTable("books", {
  ...
  isbn: text("isbn").unique(),//ISBN编号
  title: text("title").notNull(),//书名
  author: text("author").notNull(),//作者
  publisher: text("publisher"),//出版社
  publicationDate: timestamp("publication_date"),//出版日期
  categoryId: text("category_id").references(() => bookCategory.id,{ onDelete:"cascade" }),//分类ID
  price: integer("price"),//价格
  total: integer("total"),//总数
